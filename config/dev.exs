...
config :phoenix_liveview_stock_tracker, PhoenixLiveviewStockTrackerWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "JkQeHljLt/DVwFVqU2dR1zWWsC8ZBhyK2ldUvnm6PW8RZxIqlyMEONOKyK+BjzQE",
  watchers: [
...
config :phoenix_liveview_stock_tracker, PhoenixLiveviewStockTrackerWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/phoenix_liveview_stock_tracker_web/(live|views)/.*(ex)$",
      ~r"lib/phoenix_liveview_stock_tracker_web/templates/.*(eex)$"
    ]
  ]
